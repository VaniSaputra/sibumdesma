<?php $__env->startSection('title', 'Pengajuan Kelompok SPP'); ?>
      ...
      <div class="fluid">
            ...
            <div class="row justify-content-between">
                <div class="col-4 col-md-4">
                    <div class="m-2 fw-bold"><h5><i class="nav-icon fas fa-copy px-2"></i> Form Pengajuan Kelompok</h5> 
                    </div>
                </div>
                <div class="col-4 col-md-4">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sistembumdes\resources\views/dataPinjam/SPPPerguliran/formpengajuan.blade.php ENDPATH**/ ?>