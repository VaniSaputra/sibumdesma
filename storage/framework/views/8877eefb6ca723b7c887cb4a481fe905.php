      ...
      <div class="fluid">
            ...
            <div class="row justify-content-between">
                <div class="col-4 col-md-4">
                    <div class="m-2 fw-bold"><h5><i class="nav-icon fas fa-tachometer-alt"></i>&nbsp; SPP Perguliran</h5> 
                  
                    </div>
                </div>
                <div class="col-4 col-md-4">
                  <div><button type="button" class="btn btn-primary float-right" onclick="window.location='/formPengajuan'">Form Pengajuan</button></div>
                </div>
            </div>  <!-- row -->
            </div>  <!-- card -->
            <!-- BOTTON DROPDOWN / FILTER KETERANGAN -->
    ...
    <div class="container-fluid px-3">
            <!-- Bagian isi  -->
              <div class=" row justify-content-center" role="group" aria-label="Basic example">
                  <div class="col-6 text-center p-3 my-2 bg-white text-white btn btn-white" onclick="window.location='/dataSPP'">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sistembumdes\resources\views/dataSPP/anggotakelompok.blade.php ENDPATH**/ ?>