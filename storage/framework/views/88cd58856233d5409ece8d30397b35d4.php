    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  <li class="nav-item <?php echo e(\Route::is('dashboard.*') ? 'menu-open' : ''); ?>  ">
                      <a href="/dashboard" class="nav-link <?php echo e(\Route::is('dashboard.*') ? 'active' : ''); ?> ">
            ...
            <!-- ===================================    MENU DATA SPP    ========================================== -->
                  ...
                  <li class="nav-item ">
                    <a href="" class="nav-link <?php echo e(\Route::is('kelompokSPP.*','anggotaSPP.*','formKelompok.*','formAnggota.*',
                    ...
                    <ul class="nav nav-treeview">
                          <li class="nav-item">
                            <a href="/kelompokSPP" class="nav-link <?php echo e(\Route::is('kelompokSPP.*','anggotaSPP.*','formKelompok.*','formAnggota.*') ? 'active' : ''); ?> ">
                                <i class="far fa-circle nav-icon"></i>
                                <p> SPP Perguliran </p>
                            </a>
                          </li>
                          <li class="nav-item">
                              <a href="/pribadiSPP" class="nav-link <?php echo e(\Route::is('pribadiSPP.*','kendaraanSPP.*','formPribadi.*') ? 'active' : ''); ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> SPP Pribadi </p>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="/proposalPengajuan" class="nav-link <?php echo e(\Route::is('proposalPengajuan.*') ? 'active' : ''); ?>">
                              <i class="far fa-circle nav-icon"></i>
...
<?php /**PATH C:\xampp\htdocs\sistembumdes\resources\views/layout/sidebar.blade.php ENDPATH**/ ?>